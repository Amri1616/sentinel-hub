...
const incidents = [
  { id: 'PSIRP-2025-0019', title: 'Dangerous Goods Mishandling', category: 'Dangerous Goods', status: 'Closed', submitted: '2025-01-10', lastUpdated: '1 day ago', severity: 'High' },
  { id: 'PSIRP-2025-0015', title: 'Minor Warehouse Discrepancy', category: 'Discrepancy', status: 'Closed', submitted: '2025-01-05', lastUpdated: '5 days ago', severity: 'Low' },
];
...
export default function ReporterClosed() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">Closed Reports</h1>
        <p className="text-muted-foreground">Incident reports that have been resolved and closed</p>
      </div>
