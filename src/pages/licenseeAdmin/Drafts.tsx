            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left">
                  <th className="pb-3 font-medium text-muted-foreground">Reporter Name</th>
                  <th className="pb-3 font-medium text-muted-foreground">Title/Category</th>
                ...
                {filteredDrafts.length > 0 ? (
                  filteredDrafts.map((draft) => (
                    <tr key={draft.id} className="hover:bg-accent/30 transition-colors">
                      <td className="py-3 font-medium">{draft.reporter}</td>
                      <td className="py-3">
